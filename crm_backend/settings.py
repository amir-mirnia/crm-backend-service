...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST', '127.0.0.1'),  # Use 127.0.0.1 instead of localhost to avoid IPv6 issues
...
# Windows-specific: Use solo pool instead of prefork (Windows doesn't support fork)
import sys
